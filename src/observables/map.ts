...
export type ObservableMapSubscriber<TKey, TValue> = (action: ObservableMapAction, values: ObservableMapActionData<TKey, TValue>) => void
export type ObservableMapIterationCallback<TKey, TValue> = (value: TValue, key: TKey, map: Map<TKey, TValue>) => void
...
export class ObservableMap<TKey, TValue> {
    ...
    constructor(iterable?: Iterable<readonly [TKey, TValue]> | null) {
    ...
    forEach(callback: ObservableMapIterationCallback<TKey, TValue>) { this._map.forEach(callback) }
